#SCENARIO:  S12 will change the payload (L3 data ) without touching the SDNsec header , we are in the case of PVF verification.
            ...
            if dpid == 1: #s0
                ...
                if ethertype == 0x88B6 :
                    ...
                    if hmac_s1 == hmac_s1_calculated_by_s1 :
                        ...
                        # Forward the updated packet
                        self.forward_packet(dp, msg, new_packet_data, 3)
                        if ethertype == 0x88B6 :

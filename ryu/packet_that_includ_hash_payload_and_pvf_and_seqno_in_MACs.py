...
def make_custom_packet(src_mac, dst_mac, ether_type=0x88B6):
    custom_header = CustomHeader(
        ...
        hmac_s1=b'\xf1u\xc8\x03}\xa3\x1d', #MODIFICATION : these are the MACS that contains the hash of both the payload, the pvf and the seqNo
        egress_s2=2,
        #hmac_s2=b'\x7f\xc2\xaf\xfc\xce\n\x8d'
        hmac_s2=b'\x1e\x0b\xe1\x17j\tU' #MODIFICATION : these are the MACS that contains the hash of both the payload, the pvf and the seqNo
